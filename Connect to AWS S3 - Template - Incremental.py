"""
    ...
    Data Pipeline Process:
        ...
        Step 7: Select the Columns to Keep from the df Pandas DataFrame and load the data into the df_subset Pandas DataFrame

        Step 8: Load the data from the df_subset Pandas DataFrame into the Snowflake data warehouse
            ...
            4. Establish the cur cursor
                ...
                4. Transform and load the <DATA_SOURCE_NAME> <DATASET_NAME> data into the Snowflake DB_KKF_MAIN.PERSISTED.GRUBHUB_ORDER_DAILY table
                5. Merge the <DATA_SOURCE_NAME> <DATASET_NAME> data into the Snowflake DB_KKF_MAIN.GRUBHUB.FACT_ORDER table
